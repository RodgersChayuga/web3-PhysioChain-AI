...
import { RewardsTimeline } from "@/components/patient/RewardsTimeline";
import { GoalSetting } from "@/components/patient/GoalSetting";
...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8 flex justify-between items-center">
            <div className="flex items-center gap-4">
              ...
              <ShareButton achievement="87% weekly Progress" />
            </div>
              ...
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={mockProgressData}>
                    ...
                    />
                    <Line type="monotone" dataKey="sessions" stroke="#16a34a" strokeWidth={2}
                      dot={{ r: 4 }}
                      activeDot={{ r: 6 }}
      ...
      {activeTab === 'exercises' && (
        <div>Exercises Tab Content</div>
      )}
      {activeTab === 'rewards' && <RewardsTimeline />}
    </div>
  );
}